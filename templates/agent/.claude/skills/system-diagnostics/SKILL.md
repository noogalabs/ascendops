...
When present, follow `OPERATING_MODEL.md` for diagnostic scope and for distinguishing process liveness from reply-path health; otherwise, follow `AGENTS.md` as the active precedence source.
